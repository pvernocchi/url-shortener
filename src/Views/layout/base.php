...
<div class="d-flex">
    ...
    <nav class="sidebar d-none d-md-flex flex-column p-3" style="width:230px; min-width:230px;">
        ...
        <ul class="nav flex-column gap-1">
            ...
            <li class="nav-item">
                <a class="nav-link px-3 py-2" href="/admin/profile"><i class="bi bi-person me-2"></i>Profile</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link px-3 py-2" href="/admin/settings/email"><i class="bi bi-envelope-gear me-2"></i>Email</a>
            </li>
            <li class="nav-item">
